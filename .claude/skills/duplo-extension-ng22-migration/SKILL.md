...
**Count them; do not assume a number.** Helloworld has 7 components; other samples and real extensions each
...
Across the dev-kit's samples, **no source change beyond `standalone: false` was required**. A
